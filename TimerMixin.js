...
var _handles = 'TimerMixin_handles';
var _clearInteractionHandle = clearer(InteractionManager.clearInteractionHandle, _rafs);
var _createInteractionHandle = setter(InteractionManager.createInteractionHandle, _clearInteractionHandle, _rafs);
...
var TimerMixin = {
  ...
  componentWillUnmount: function() {
    ...
    this[_handles] && this[_handles].forEach(function(id) {
